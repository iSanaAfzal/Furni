            ...
            <div class="row justify-content-between">
                <div class="col-lg-5">
                    <div class="intro-excerpt">
                        ...
                        <p><a href="{{ route('furni.shop') }}" class="btn btn-secondary me-2">Shop Now</a><a href="#"
    ...
    <div class="product-section">
        <div class="container">
            <div class="row">
                ...
                <!-- Start Column 2 -->
                @foreach ($approveproduct as $approve)
                    <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                        <a class="product-item" href="{{ route('furni.cart', ['id' => $approve->id]) }}">
                            <img src="{{ asset('storage/' . $approve->image) }}" class="img-fluid product-thumbnail">
                            <h3 class="product-title">{{ $approve->name }}</h3>
                            <strong class="product-price">{{ $approve->price }}</strong>
